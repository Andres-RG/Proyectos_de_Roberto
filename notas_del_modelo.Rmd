...
$$\begin{array}{l}
\text{Para el grupo 1 :} \\
\dot S_1 = -\beta_1 S_1 * ( I_1 + I_2 + I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4} )  \\
\dot E_1 = \beta_1 S_1 * ( I_1 + I_2 + I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4} ) - \alpha E_1 \\
...
\\
\text{Para el grupo 2 :} \\
\dot S_2 = -\beta_2 S_2 * ( I_1 + I_2 + I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4} ) \\
\dot E_2 = \beta_2 S_2 * ( I_1 + I_2 + I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4} ) - \alpha E_2 \\
...
\\
\text{Para el grupo 3 :} \\
\dot S_3 = -\beta_3 S_3 * ( I_1 + I_2 + I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4} ) \\
\dot E_3 = \beta_3 S_3 * ( I_1 + I_2 + I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4} ) - \alpha E_3 \\
...
\\
\text{Para el grupo 4 :} \\
\dot S_4 = -\beta_4 S_4 * ( I_1 + I_2 + I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4} ) \\
\dot E_4 = \beta_4 S_4 * ( I_1 + I_2 + I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4} ) - \alpha E_4 \\
...
modelo_covid <- function(t, x, params) {
  ...
  with(as.list(params), 
       
       {
         ...
         ## GRUPO 1
         S1 <- - B_1 * S1 * (I1 + I2 + I3 + I4 + I_l1 + I_l2 + I_l3 + I_l4)
         E1 <- B_1 * S1 * (I1 + I2 + I3 + I4 + I_l1 + I_l2 + I_l3 + I_l4) - ( alpha * E1 )
         ...
         ## GRUPO 2
         S2 <- - B_2 * S2 * (I1 + I2 + I3 + I4 + I_l1 + I_l2 + I_l3 + I_l4)
         E2 <- B_2 * S2 * (I1 + I2 + I3 + I4 + I_l1 + I_l2 + I_l3 + I_l4) - ( alpha * E2 )
         ...
         ## GRUPO 3
         S3 <- - B_3 * S3 * (I1 + I2 + I3 + I4 + I_l1 + I_l2 + I_l3 + I_l4)
         E3 <- B_3 * S3 * (I1 + I2 + I3 + I4 + I_l1 + I_l2 + I_l3 + I_l4) - ( alpha * E3 )
         ...
         ## GRUPO 4
         S4 <- - B_4 * S4 * (I1 + I2 + I3 + I4 + I_l1 + I_l2 + I_l3 + I_l4)
         E4 <- B_4 * S4 * (I1 + I2 + I3 + I4 + I_l1 + I_l2 + I_l3 + I_l4) - ( alpha * E4 )
